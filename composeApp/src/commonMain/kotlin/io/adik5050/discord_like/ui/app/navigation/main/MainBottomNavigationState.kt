...
@Composable
fun rememberMainBottomNavigationState(
    startRoute: NavKey,
    ...
    val topLevelRoute = rememberSerializable(
        startRoute,
        topLevelRoutes,
        configuration = serializersConfiguration,
...
val serializersConfiguration = SavedStateConfiguration {
...
@Composable
fun MainBottomNavigationState.toEntries(
